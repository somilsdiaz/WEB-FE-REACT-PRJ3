      ...
      .then((response) => {
        ...
        const groupedData = opportunities.reduce(
          (acc: Record<string, number>, curr: any) => {
            acc[curr.businessLine] = (acc[curr.businessLine] || 0) + 1;
            return acc;
          },
          {}
        );
  ...
  return (
    <div className="flex flex-col items-center w-full h-[400px] md:h-[500px]">
      <h2 className="text-lg font-semibold text-gray-700 mb-4">
        Porcentaje de Oportunidades por Línea de Negocio
      </h2>
...
export default BusinessLinePieChart;
